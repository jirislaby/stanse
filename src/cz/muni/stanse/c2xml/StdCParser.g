...
TODO:
	- fix typedefs
	- everything else from ANSI C99

EXTRA: 
	- added the ITI header
	- using ExtentLexerInputState (TODO - why?)
	- super.newline() (TODO - why?)
...
{
    // Suppport C++-style single-line comments in ANSI C99
    ...
    public void popScope() {
      symbolTable.popScope();
        ...
        public void reportError(RecognitionException ex) {
          try {
            System.err.println("ANTLR Parsing Essssssrror: "+ex + " token name:" + tokenNames[LA(1)]);
...
// Iteration statements:
        ...
        |!       "for"
                LPAREN ( d1:declaration | (e1:expr)? SEMI ) ( e2:expr )? SEMI ( e3:expr )? RPAREN
                s:statement
                                    {
...
//    tok.setLine(lineObject.line);
    ((ExtentLexerSharedInputState) inputState).annotate(tok); // ITI 
