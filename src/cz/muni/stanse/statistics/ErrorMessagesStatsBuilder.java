...
class MessagesStat {
    ...
    MessagesStat(final List errElements) {
...
final class ComposedSectionedMessagesStat extends SectionedMessagesStat {
    ...
    ComposedSectionedMessagesStat(final String sectionName,
                            final List errElements, final MessagesStat overalls,
                            final Vector<SectionedMessagesStat> descStats) {
        super(sectionName,errElements,overalls);
...
public final class ErrorMessagesStatsBuilder {
    ...
    buildPerCheckerStats(final List errElements, final MessagesStat overalls) {
        ...
        for (final Pair<String,Vector<Element>> item :
            ...
            result.add(
                new ComposedSectionedMessagesStat(
                        item.getFirst(),item.getSecond(),overalls,
                        buildDescStats(item.getSecond(),overalls)));
        return result;
    }

    private static Vector<SectionedMessagesStat>
    buildDescStats(final List errElements,final MessagesStat overalls) {
