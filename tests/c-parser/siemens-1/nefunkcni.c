# 1 "./linux/performance/kernel_module/sc_km_patch.c"
# 1 "<built-in>"
# 1 "<command line>"
# 1 "./linux/performance/kernel_module/sc_km_patch.c"
# 44 "./linux/performance/kernel_module/sc_km_patch.c"
...
# 136 "../linux-2.6.18/include/linux/types.h"
...
# 306 "../linux-2.6.18/include/asm/system.h"
...
# 9 "../linux-2.6.18/include/asm/tsc.h"
...
# 10 "../linux-2.6.18/include/asm/tsc.h" 2
...
# 427 "../linux-2.6.18/include/linux/jiffies.h"
 return x;
}
...
# 1 "../linux-2.6.18/include/asm/rwsem.h" 1
# 45 "../linux-2.6.18/include/asm/rwsem.h"
struct rwsem_waiter;
...
# 84 "../linux-2.6.18/include/asm/rwsem.h"
extern void __init_rwsem(struct rw_semaphore *sem, const char *name,
    struct lock_class_key *key);
# 97 "../linux-2.6.18/include/asm/rwsem.h"
...
# 25 "../linux-2.6.18/include/linux/rwsem.h" 2
...
# 282 "../linux-2.6.18/include/linux/sched.h"
...
# 982 "../linux-2.6.18/include/linux/sched.h"
...
# 1127 "../linux-2.6.18/include/linux/sched.h"
...
# 89 "../linux-2.6.18/include/linux/sysfs.h"
extern int
...
# 217 "../linux-2.6.18/include/linux/module.h"
struct module_ref
{
 local_t count;
...
# 455 "../linux-2.6.18/include/linux/module.h"
...
# 45 "./linux/performance/kernel_module/sc_km_patch.c" 2
...
# 1 "./linux/performance/kernel_module/sc_km_patch_int.h" 1
# 51 "./linux/performance/kernel_module/sc_km_patch_int.h"
# 1 "./linux/performance/kernel_module/sc_km_patch.h" 1
# 50 "./linux/performance/kernel_module/sc_km_patch.h"
# 1 "../linux-2.6.18/include/linux/version.h" 1
# 51 "./linux/performance/kernel_module/sc_km_patch.h" 2
...
# 89 "./linux/performance/kernel_module/sc_km_patch.h"
typedef struct SC_StackFrameExt {
 s32 id;
 s32 ebp;
 unsigned long int retAddr;
} SC_StackFrameExt_t;
# 104 "./linux/performance/kernel_module/sc_km_patch.h"
...
# 125 "./linux/performance/kernel_module/sc_km_patch.h"
typedef void (*SC_TraceEndFun_t) (
 s32 id,
 SC_StackFrameExt_t *stack,
 s32 write_trace_f
);
# 147 "./linux/performance/kernel_module/sc_km_patch.h"
void sckpatch_set_debug_level(int in_debug_level);
# 163 "./linux/performance/kernel_module/sc_km_patch.h"
...
# 191 "./linux/performance/kernel_module/sc_km_patch.h"
...
# 203 "./linux/performance/kernel_module/sc_km_patch.h"
scpatch_return_codes_t sckpatch_unpatch_fn ( s32 in_id );
# 226 "./linux/performance/kernel_module/sc_km_patch.h"
...
# 238 "./linux/performance/kernel_module/sc_km_patch.h"
scpatch_return_codes_t sckpatch_unpatch_irqfn ( s32 in_id );
# 252 "./linux/performance/kernel_module/sc_km_patch.h"
scpatch_return_codes_t sckpatch_patch_ctxswitch ( SC_TraceStartFun_ctxswitch_t in_trace_func_ctxswitch_p );
# 262 "./linux/performance/kernel_module/sc_km_patch.h"
scpatch_return_codes_t sckpatch_unpatch_ctxswitch ( void );
# 52 "./linux/performance/kernel_module/sc_km_patch_int.h" 2
# 185 "./linux/performance/kernel_module/sc_km_patch_int.h"
...
# 223 "./linux/performance/kernel_module/sc_km_patch_int.h"
...
# 313 "./linux/performance/kernel_module/sc_km_patch_int.h"
extern int check_mem_kernel_ok(unsigned long int in_address, unsigned long int in_length);
# 53 "./linux/performance/kernel_module/sc_km_patch.c" 2
# 61 "./linux/performance/kernel_module/sc_km_patch.c"
# 1 "./linux/performance/kernel_module/sc_km_patch_arch_iax86.h" 1
# 51 "./linux/performance/kernel_module/sc_km_patch_arch_iax86.h"
# 1 "../linux-2.6.18/include/linux/smp_lock.h" 1
# 52 "./linux/performance/kernel_module/sc_km_patch_arch_iax86.h" 2
...
# 1 "../linux-2.6.18/include/asm-i386/mach-default/irq_vectors.h" 1
# 87 "../linux-2.6.18/include/asm-i386/mach-default/irq_vectors.h"
# 1 "../linux-2.6.18/include/asm-i386/mach-default/irq_vectors_limits.h" 1
# 88 "../linux-2.6.18/include/asm-i386/mach-default/irq_vectors.h" 2
...
struct irq_desc {
 ...
 spinlock_t lock;
# 165 "../linux-2.6.18/include/linux/irq.h"
...
# 65 "../linux-2.6.18/include/linux/profile.h"
...
# 103 "../linux-2.6.18/include/linux/interrupt.h"
extern void disable_irq_nosync(unsigned int irq);
extern void disable_irq(unsigned int irq);
extern void enable_irq(unsigned int irq);
# 118 "../linux-2.6.18/include/linux/interrupt.h"
...
# 53 "./linux/performance/kernel_module/sc_km_patch_arch_iax86.h" 2
# 82 "./linux/performance/kernel_module/sc_km_patch_arch_iax86.h"
...
# 143 "./linux/performance/kernel_module/sc_km_patch_arch_iax86.h"
typedef enum
{
 I_TYPE_UNKNOWN,
 I_TYPE_Jcc,
...
# 160 "./linux/performance/kernel_module/sc_km_patch_arch_iax86.h"
typedef enum
{
 I_OP_TYPE_NONE,
 I_OP_TYPE_REG,
...
# 279 "./linux/performance/kernel_module/sc_km_patch_arch_iax86.h"
...
# 62 "./linux/performance/kernel_module/sc_km_patch.c" 2
# 73 "./linux/performance/kernel_module/sc_km_patch.c"
...
# 94 "./linux/performance/kernel_module/sc_km_patch.c"
...
# 790 "./linux/performance/kernel_module/sc_km_patch.c"
...
# 833 "./linux/performance/kernel_module/sc_km_patch.c"
...
# 860 "./linux/performance/kernel_module/sc_km_patch.c"
 if ( 0 != switch_to_patched_f )
 {
  SC_doUnPatchSwitch_to((FUNCPTR) switch_to_addr);
 }
# 874 "./linux/performance/kernel_module/sc_km_patch.c"
 kfree (gPatchFunc);
 gPatchFunc = ((void *)0);
